...
pub mod publishing;
pub mod storage;
// Marketplace directory Plugin (public read role).
...
struct MarketplaceDirectory {
    ...
    storage: Option<Rc<dyn PublishedStorage>>,
    ready: Rc<Cell<bool>>,
    #[tasks]
...
mod tests {
    use super::*;
    use crate::publishing::Directory;
    use lenso_kernel::{CancellationToken, NativeRequestEndpoint};
    use lenso_plugin_catalog::{Trust, verify};
